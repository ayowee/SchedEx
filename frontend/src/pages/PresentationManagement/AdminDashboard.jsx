            ...
            <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <button
                        ...
                        disabled={loading || filteredPresentations.length === 0}
                        className="px-3 py-2 bg-green-50 text-green-600 hover:bg-green-100 rounded-lg text-sm flex items-center justify-between transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
